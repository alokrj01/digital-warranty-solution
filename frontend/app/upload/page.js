...
import { Upload, Image as ImageIcon, Loader2, X, AlertCircle, CheckCircle2 } from 'lucide-react';
        ...
        {status === 'loading' && (
          <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-blue-600/95 backdrop-blur-lg text-white text-center p-6">
            <div className="relative mb-8">
              <Loader2 className="animate-spin text-blue-200" size={84} strokeWidth={1.5} />
        ...
        <main className="max-w-xl mx-auto p-6 mt-12">
          <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100">
            <header className="mb-8">
              <h1 className="text-3xl font-black text-slate-900 tracking-tight">Add Warranty</h1>
              <p className="text-slate-500 mt-1 text-sm">Upload a bill to auto-extract details.</p>
            </header>
                ...
                {preview ? (
                  ...
                  <label className="flex flex-col items-center justify-center w-full h-80 border-2 border-dashed border-slate-200 rounded-[2rem] cursor-pointer bg-slate-50 hover:bg-blue-50/50 hover:border-blue-400 transition-all group">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-sm font-bold text-slate-700">Select Receipt Image</p>
                      <p className="text-xs text-slate-400 mt-1 italic font-medium">Max size: 5MB</p>
                    </div>
